...
def convert_ss_box(path):
    paths_catalog = import_file(
        "wetectron.config.paths_catalog", os.path.join(path, "wetectron/config/paths_catalog.py"), True)
